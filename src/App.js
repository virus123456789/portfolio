    ...
    <div className="w-full mx-auto font-lexend">
        <div className="relative max-w-7xl mx-auto h-[480px] flex justify-between items-center overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto p-6 flex flex-col md:flex-row justify-between items-center">
              <div className="w-56 flex md:flex-col justify-start items-start">
                  <h1 className="text-7xl text-blue-900 font-bold">2+</h1>
                  <h5 className="text-2xl font-semibold text-blue-500">Years Experience Working</h5>
              </div>
              <div className="flex justify-start items-center space-x-2">
                <div className="w-44 h-44 p-6 bg-blue-50 rounded-lg flex flex-col justify-end items-start">
